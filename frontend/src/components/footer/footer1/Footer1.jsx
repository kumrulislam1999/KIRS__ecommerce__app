...
const Footer1 = () => {
  return (
    <div id="footer1__section" >
      <div className="sec__pad">
        <div className="container">
          <div id="footer__top">
            <div className="row align-items-center justify-content-between g-0">
            <div className="col-12 col-sm-4 col-md-3" id='footer__logo__box'>
              <div id='logo__box'>
                <img src={logo__img} alt="footer logo" />
              </div>
            </div>
            <div className="col-12 col-sm-4 col-md-5" id='footer__card__box'>
              <div id="payment__box">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error laborum, architecto sed, cupiditate libero veritatis facilis assumenda est nostrum </p>
              </div>
            </div>
            <div className="col-12 col-sm-4 col-md-3" id='footer__social__box'>
              <div id="social__box">
                <ul id="social__media">
                  {
